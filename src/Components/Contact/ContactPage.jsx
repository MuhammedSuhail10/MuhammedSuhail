          ...
          <Grid container >
            <Grid item sm={12} md={8}>
              <div className=' flex flex-col md:w-[90%] '>
                <img src={scar} alt="" className='absolute pr-[3em] md:mt-[-4em] md:hidden mt-[-1em] drop-shadow opacity-25 h-[12em]' />
                <form ref={form} className='relative' onSubmit={sendEmail}>
            ...
            <Grid item md={4} sm={12} className='hidden md:block '>
              <img src={scar} alt="" className='absolute pr-[3em] md:mt-[-4em] drop-shadow opacity-25 h-[12em]' />
              <div className=' relative mt-[5em]  ' >
                <h5 className=' uppercase text-[#e9ecef] opacity-55 font-serif text-[10pt] tracking-widest cursor-default '>Contact Details</h5>
                <div className='pt-[1em] text-[15pt] font-mono opacity-80 tracking-wide'>
                  <h3 className=' hover:text-[#575757] cursor-default'>Ernakulam,Kerala</h3>
                  <a className='hover:text-[#575757]' href='mailto:muhammedsuhusuhail@gmail.com' >muhammedsuhusuhail@gmail.com</a>
                </div>
              </div>
              <div className=' mt-[4em] hidden md:block ' >
                <h5 className=' uppercase text-[#e9ecef] opacity-55 font-serif text-[10pt] tracking-widest cursor-default '>Social</h5>
                <div className='flex flex-col pt-[1em] text-[15pt] font-mono opacity-80 tracking-wide'>
                  <Link className='hover:text-[#575757]' to='https://www.instagram.com/suh.41.l/?igshid=NGVhN2U2NjQ0Yg%3D%3D' target='_blank' >Instagram</Link>
                  <Link className='hover:text-[#575757]' to='https://t.me/Gottei_13' target='_blank' >Telegram</Link>
                  <Link className='hover:text-[#575757]' to='https://www.linkedin.com/in/muhammed-suhail-66b1a4283/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' target='_blank' >LinkedIn</Link>
                  <Link className='hover:text-[#575757]' to='https://github.com/MuhammedSuhail10' target='_blank' >GitHub</Link>
                </div>
              </div>
            </Grid>
          </Grid>
