  ...
  return (
    <>
      <header className='flex justify-center flex-col text-[#FEFAE0]' id='head' style={{ alignItems: 'center', height: '80%' }}>
        <img src={scar} alt="" className='absolute mr-[35em] drop-shadow opacity-50 h-[20em]' />
        <h2 className='text-[2em] text-center font-[Russo] '>Yahhō , Myself <span style={{ color: '#34A0A4' }} id='spanName' className='transition duration-[0.5s] ease-in-out delay-150 hover:text-[#e63946]'>Muhammed Suhail</span></h2>
